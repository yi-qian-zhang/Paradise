...
/**
 * This class represents the wartortle in the game.
 * @author Boning Li
 * @version 1.0
 */
public class Wartortle extends Monster
{
    private int counter = 0;
    private boolean started = false;

    public Wartortle(float x, float y, Stage s, String[] files) { super(x, y, s, files); }
