...
/**
 * This class represents the rhydon in the game.
 * @author Boning Li
 * @version 1.0
 */
public class Rhydon extends Monster
{
    ...
    public Rhydon(float x, float y, Stage s, String file) { super(x, y, s, file); }
    ...
    public void act(float dt)
    {
        ...
        else if(active)
        {
            if(timer >= 3)
            {
                ...
                setMovement(250, (getMotionAngle()+180)%360);
                timer = 0;
            }
            timer += dt;
        }
