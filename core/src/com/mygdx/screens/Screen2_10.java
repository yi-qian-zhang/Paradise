...
import com.mygdx.monster.round_2.Magikarp;
...
/**
 * This Screen represents map 2-10
 * @author Yang Tang
 * @version 1.0
 */
public class Screen2_10 extends LevelScreen {

    static {
        fileName = "maps/map_2/Map 2-10.tmx";
        thisScreenClass = "com.mygdx.screens.Screen2_10";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon31")) {
            MapProperties props = obj.getProperties();
            new Magikarp((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_2/monster_21/21-1.png");
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1"))
            if (jack.overlaps(end1)) {
               start = "Start1";
                ParadiseGame.setActiveScreen(new Screen2_11());
            }
