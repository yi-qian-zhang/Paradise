...
import com.mygdx.monster.round_2.Poliwrath;
...
/**
 * This Screen represents map 2-11
 * @author Yang Tang
 * @version 1.0
 */
public class Screen2_11 extends LevelScreen {

    static {
        fileName = "maps/map_2/Map 2-11.tmx";
        thisScreenClass = "com.mygdx.screens.Screen2_11";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon32")) {
            MapProperties props = obj.getProperties();
            String[] files = {"monster/round_2/monster_8/8-1.png", "monster/round_2/monster_8/8-2.png"};
            new Poliwrath((float) props.get("x"), (float) props.get("y"), mainStage, files);
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1"))
            if (jack.overlaps(end1)) {
               start = "Start1";
                ParadiseGame.setActiveScreen(new Screen2_12());
            }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_2.Poliwrath")) {
