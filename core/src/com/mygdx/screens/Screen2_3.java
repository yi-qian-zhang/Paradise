...
import com.mygdx.monster.round_2.Golduck;
import com.mygdx.monster.round_2.Gyarados;
import com.mygdx.monster.round_2.Poliwag;
import com.mygdx.monster.round_2.Poliwhirl;
...
/**
 * This Screen represents map 2-3
 * @author Yang Tang
 * @version 1.0
 */
public class Screen2_3 extends LevelScreen {
    static {
        fileName = "maps/map_2/Map 2-3.tmx";
        nextScreenClass = "com.mygdx.screens.Screen2_2";
        thisScreenClass = "com.mygdx.screens.Screen2_3";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon19")) {
            MapProperties props = obj.getProperties();
            new Poliwhirl((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_2/monster_7/7-1.png");
        }

        for (MapObject obj : tma.getTileList("Mon20")) {
            MapProperties props = obj.getProperties();
            String[] files = {"monster/round_2/monster_22/22-1.png", "monster/round_2/monster_22/22-2.png"};
            new Gyarados((float) props.get("x"), (float) props.get("y"), mainStage, files);
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1")) {
            if (jack.overlaps(end1)) {
                start = "Start1";
                ParadiseGame.setActiveScreen(new Screen2_10());
            }
        }
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_2/tip4.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip2")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip2.x, Tip2.y, mainStage, "items/tips/map_2/tip5.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_2.Gyarados")) {
