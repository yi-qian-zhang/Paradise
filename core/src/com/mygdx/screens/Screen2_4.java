...
/**
 * This Screen represents map 2-4
 * @author Yang Tang
 * @version 1.0
 */
public class Screen2_4 extends LevelScreen {

    static {
        fileName = "maps/map_2/Map 2-4.tmx";
        thisScreenClass = "com.mygdx.screens.Screen2_4";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon21")) {
            MapProperties props = obj.getProperties();
            Goldeen goldeen = new Goldeen((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_2/monster_17/17-1.png");
            goldeen.setMovement(200, 270);
        }
        ...
        for (MapObject obj : tma.getRectangleList("End4")) {
            MapProperties props = obj.getProperties();
            new End4((float) props.get("x"), (float) props.get("y"), mainStage);
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1"))
            if (jack.overlaps(end1)) {
               start = "Start1";
                ParadiseGame.setActiveScreen(new Screen2_5());
            }
        ...
        for (BaseActor end4 : BaseActor.getList(mainStage, "com.mygdx.maps.End4"))
            if (jack.overlaps(end4)) {
                start = "Start4";
                ParadiseGame.setActiveScreen(new Screen2_5());
            }
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y - 150, mainStage, "items/tips/map_2/tip6.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_2.Goldeen")) {
