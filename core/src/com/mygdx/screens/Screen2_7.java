...
import com.mygdx.monster.round_2.Tentacool;
...
/**
 * This Screen represents map 2-7
 * @author Yang Tang
 * @version 1.0
 */
public class Screen2_7 extends LevelScreen {

    static {
        fileName = "maps/map_2/Map 2-7.tmx";
        thisScreenClass = "com.mygdx.screens.Screen2_7";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon25")) {
            MapProperties props = obj.getProperties();
            String[] files = {"monster/round_2/monster_9/9-1.png", "monster/round_2/monster_9/9-2.png"};
            new Tentacool((float) props.get("x"), (float) props.get("y"), mainStage, files);
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1"))
            if (jack.overlaps(end1)) {
               start = "Start1";
                ParadiseGame.setActiveScreen(new Screen2_8());
            }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_2.Tentacool")) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_2/tip12.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor springboard : BaseActor.getList(mainStage, "com.mygdx.maps.Springboard"))
