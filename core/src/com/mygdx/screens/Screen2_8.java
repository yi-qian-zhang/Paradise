...
import com.mygdx.monster.round_2.Tentacruel;
...
/**
 * This Screen represents map 2-8
 * @author Yang Tang
 * @version 1.0
 */
public class Screen2_8 extends LevelScreen {

    static {
        fileName = "maps/map_2/Map 2-8.tmx";
        thisScreenClass = "com.mygdx.screens.Screen2_8";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon26")) {
            MapProperties props = obj.getProperties();
            String[] files = {"monster/round_2/monster_10/10-1.png", "monster/round_2/monster_10/10-2.png"};
            new Tentacruel((float) props.get("x"), (float) props.get("y"), mainStage, files);
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_2.Tentacruel")) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_2/tip13.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip2")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip2.x - 100, Tip2.y - 50, mainStage, "items/tips/map_2/tip14.png");
                tip.remove();
            }
        }
