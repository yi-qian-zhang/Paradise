...
/**
 * This Screen represents map 3-1
 * @author Yang Tang
 * @version 1.0
 */
public class Screen3_1 extends LevelScreen {
    static {
        fileName = "maps/map_3/Map 3-1.tmx";
        nextScreenClass = "com.mygdx.screens.Screen3_2";
        thisScreenClass = "com.mygdx.screens.Screen3_1";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon34")) {
            MapProperties props = obj.getProperties();
            new Farfetchd((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_3/monster_10/10-1.png");
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1")) {
            if (jack.overlaps(end1)) {
                start = "Start";
                ParadiseGame.setActiveScreen(new Screen3_4());
            }
        }
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_3/tip1.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_3.Farfetchd")) {
