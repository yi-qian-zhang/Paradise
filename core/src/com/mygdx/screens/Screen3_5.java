...
import com.mygdx.monster.round_3.Golbat;
...
/**
 * This Screen represents map 3-5
 * @author Yang Tang
 * @version 1.0
 */
public class Screen3_5 extends LevelScreen {
    static {
        fileName = "maps/map_3/Map 3-5.tmx";
        thisScreenClass = "com.mygdx.screens.Screen3_5";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon43")) {
            MapProperties props = obj.getProperties();
            new Golbat((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_3/monster_9/9-1.png");
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1")) {
            if (jack.overlaps(end1)) {
                start = "Start";
                ParadiseGame.setActiveScreen(new Screen3_6());
            }
        }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_3.Golbat")) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_3/tip6.png");
                tip.remove();
            }
        }
