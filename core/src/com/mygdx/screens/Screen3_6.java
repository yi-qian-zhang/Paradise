...
/**
 * This Screen represents map 3-6
 * @author Yang Tang
 * @version 1.0
 */
public class Screen3_6 extends LevelScreen {
    static {
        fileName = "maps/map_3/Map 3-6.tmx";
        thisScreenClass = "com.mygdx.screens.Screen3_6";
    }
    ...
    public void update(float dt) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x - 300, Tip1.y - 200, mainStage, "items/tips/map_3/tip7.png");
                tip.remove();
            }
        }
