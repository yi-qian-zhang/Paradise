...
/**
 * This Screen represents map 3-7
 * @author Yang Tang
 * @version 1.0
 */
public class Screen3_7 extends LevelScreen {
    static {
        fileName = "maps/map_3/Map 3-7.tmx";
        thisScreenClass = "com.mygdx.screens.Screen3_7";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon44")) {
            MapProperties props = obj.getProperties();
            new Foffing((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_3/monster_13/13-1.png");
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_3/tip8.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip2")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip2.x - 300, Tip2.y - 150, mainStage, "items/tips/map_3/tip9.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_3.Foffing")) {
