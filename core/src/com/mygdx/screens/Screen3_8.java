...
import com.mygdx.monster.round_3.Weezing;
...
/**
 * This Screen represents map 3-8
 * @author Yang Tang
 * @version 1.0
 */
public class Screen3_8 extends LevelScreen {
    static {
        fileName = "maps/map_3/Map 3-8.tmx";
        thisScreenClass = "com.mygdx.screens.Screen3_8";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon45")) {
            MapProperties props = obj.getProperties();
            new Weezing((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_3/monster_14/14-1.png");
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor end1 : BaseActor.getList(mainStage, "com.mygdx.maps.End1")) {
            if (jack.overlaps(end1)) {
                start = "Start";
                ParadiseGame.setActiveScreen(new Screen3_9());
            }
        }
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_3.Weezing")) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x + 50, Tip1.y - 200, mainStage, "items/tips/map_3/tip10.png");
                tip.remove();
            }
        }
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip2")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip2.x - 300, Tip2.y - 150, mainStage, "items/tips/map_3/tip11.png");
                tip.remove();
            }
        }
