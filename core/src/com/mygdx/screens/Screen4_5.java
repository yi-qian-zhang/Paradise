...
import com.mygdx.monster.round_4.Geodude;
import com.mygdx.monster.round_4.Graveler;
...
/**
 * This Screen represents map 4-5
 * @author Yang Tang
 * @version 1.0
 */
public class Screen4_5 extends LevelScreen {
    static {
        fileName = "maps/map_4/Map 4-5.tmx";
        thisScreenClass = "com.mygdx.screens.Screen4_5";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon57")) {
            MapProperties props = obj.getProperties();
            new Geodude((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_4/monster_13/13-1.png");
        }

        for (MapObject obj : tma.getTileList("Mon58")) {
            MapProperties props = obj.getProperties();
            new Graveler((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_4/monster_14/14-1.png");
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_4.Graveler")) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_4/tip9.png");
                tip.remove();
            }
        }
