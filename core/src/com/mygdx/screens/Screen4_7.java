...
import com.mygdx.monster.round_4.Golem;
...
/**
 * This Screen represents map 4-7
 * @author Yang Tang
 * @version 1.0
 */
public class Screen4_7 extends LevelScreen {
    static {
        fileName = "maps/map_4/Map 4-7.tmx";
        thisScreenClass = "com.mygdx.screens.Screen4_7";
    }
    ...
    public void initialize() {
        ...
        for (MapObject obj : tma.getTileList("Mon61")) {
            MapProperties props = obj.getProperties();
            new Golem((float) props.get("x"), (float) props.get("y"), mainStage, "monster/round_4/monster_15/15-1.png");
        }
    ...
    public void update(float dt) {
        ...
        for (BaseActor monster : BaseActor.getList(mainStage, "com.mygdx.monster.round_4.Golem")) {
        ...
        for (BaseActor tip : BaseActor.getList(mainStage, "com.mygdx.maps.Tip1")) {
            if (jack.overlaps(tip) && Gdx.input.isKeyPressed(Input.Keys.Q)) {
                new TipActor(Tip1.x, Tip1.y, mainStage, "items/tips/map_4/tip11.png");
                tip.remove();
            }
        }
